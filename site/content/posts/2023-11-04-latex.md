...
On Mac OS, [Skim](https://skim-app.sourceforge.io/) is a PDF reader which has a key feature: it reloads when the PDF changes contents.  I find this nicer than Preview, which requires me to click on the window to get it to reload.
